...
if [ "$use_existing_models" == "true" ]; then
  ...
  run.pl ${plda_vec_dir}/log/compute_mean.log \
    ivector-normalize-length scp:${plda_vec_dir}/xvector.scp \
  ...
  run.pl $plda_vec_dir/log/plda.log \
    ...
    "ark:ivector-normalize-length scp:${plda_vec_dir}/xvector.scp  ark:- |" \
...
run.pl $scores_dir/log/plda_scoring.log \
  ivector-plda-scoring --normalize-length=true \
    ...
    "ark:ivector-subtract-global-mean ${plda_vec_dir}/mean.vec scp:${enroll_vec_dir}/spk_xvector.scp ark:- | ivector-normalize-length ark:- ark:- |" \
    "ark:ivector-normalize-length scp:${test_vec_dir}/xvector.scp ark:- | ivector-subtract-global-mean ${plda_vec_dir}/mean.vec ark:- ark:- | ivector-normalize-length ark:- ark:- |" \
